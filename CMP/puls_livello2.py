...
class ClickableWidget(QWidget):
    ...
    def __init__(self, image_path, text, parent=None):
        ...
        self.image_label.setPixmap(QPixmap(ico).scaled(100, 100, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
        ...
        self.setFixedSize(QSize(550, 120))
